...
namespace CleanCodeLaboration.Model.GameLogic.Strategy.Interface
{
    public interface IGameStrategy
    {
        ...
        string EvaluateGuess(string guess); //Fungerar Evaluate som namn?? Det kanske också är en metod som ska gömmas bakom en Get-metod? eller Kanske ha en privat EvaluateGuess-metod och sen döper du omd enna metod till GetEvaluatedGuess?
